...
graph = Graph()
graph.add_vertex("Afghanistan")
graph.add_vertex("Bangladesh")
graph.add_vertex("China")
graph.add_edge("Afghanistan", "Bangladesh")
graph.add_edge("Afghanistan", "China")
graph.add_edge("Bangladesh", "China")
print(graph)