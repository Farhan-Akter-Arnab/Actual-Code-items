...
def main():
  ...
  while not done:
    ...
    if x == 0: current_color = colors['black']
    elif x == screen_width - sprite_width: current_color = colors['blue']
    elif y == 0: current_color = colors['orange']
    elif y == screen_height - sprite_height: current_color = colors['teal']
