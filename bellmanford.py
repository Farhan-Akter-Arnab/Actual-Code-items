class Graph:
    ...
    def BellmanFord(self, src):
        ...
        for u, v, w in self.graph:
            if dist[u] != float("inf") and dist[u] + w < dist[v]: print("Graph contains negative weight cycle"); return
        self.printArr(dist)
if __name__ == "__main__":
    ...
    g.addEdge(1, 2, 3)
    g.addEdge(1, 3, 2)
    g.addEdge(1, 4, 2); g.addEdge(3, 2, 5); g.addEdge(3, 1, 1); g.addEdge(4, 3, -3)
    g.BellmanFord(0)